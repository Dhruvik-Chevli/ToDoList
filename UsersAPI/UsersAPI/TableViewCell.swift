...
class TableViewCell: UITableViewCell {
    ...
    func setLabelConstraints(){
        eusername.topAnchor.constraint(equalTo: topAnchor, constant: 10).isActive = true
        eusername.heightAnchor.constraint(equalToConstant: 25).isActive  = true
        eusername.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        ...
        ename.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        ...
        locPin.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        locPin.widthAnchor.constraint(equalToConstant: 25).isActive = true
        //ecity.topAnchor.constraint(equalTo: ename.bottomAnchor, constant: 10).isActive = true
        ...
        phoneiv.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        ...
        enumber.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10).isActive = true
        //enumber.widthAnchor.constraint(lessThanOrEqualToConstant: 1000).isActive = true
        ...
        wsiv.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        ...
        ewebsite.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10).isActive = true
        ...
        ecomp.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30).isActive = true
        ecomp.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -10).isActive = true
    }
